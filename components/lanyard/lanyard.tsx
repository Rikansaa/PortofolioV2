...
const DEFAULT_CARD_GLB = "/models/card.glb";

function createDefaultBandTexture() {
...
function Band({
  ...
  const band = useRef<THREE.Mesh<any, any> | null>(null);
  ...
  const { nodes, materials } = useGLTF(DEFAULT_CARD_GLB) as unknown as {
  ...
  const defaultBandTex = useMemo(() => createDefaultBandTexture(), []);
  const texture = lanyardImage ? customBandTex : defaultBandTex;
